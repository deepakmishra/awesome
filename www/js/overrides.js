$(document).on("pagecreate","#home", function() {
    ...
    function populateCurrent() {
        ...
        $(".current .image img").attr("src",sample_image_urls[index%sample_source_urls.length]);
        ...
        $(".original a").attr("href","http://www.google.com");
    ...
    navigator.geolocation.watchPosition(geo_success, geo_error, { maximumAge: 3600000, timeout: 10000, enableHighAccuracy: false });
    ...
    $("#bars-button").css("background-color",$(".small").css("background-color"))
